...
#    
    ...
    replication_temp = "ImageMath 3 %s/replicated_invivo.nii.gz ReplicateDisplacement %s/invivo/invivoTemplate.nii.gz 112 3 0"%(warp_results_folder,path_to_atlas_folder)
...
#            os.system("touch %s"%check_the_confounds)
    ...
    for i in os.listdir(warped_epi):
        ...
        os.system(avgcall)
        os.system("antsApplyTransforms -d 4 -o %s/%s -t /home/ozzy/Desktop/raged/warpy1Warp.nii.gz -t /home/ozzy/Desktop/raged/warpy0GenericAffine.mat -r /home/ozzy/git/mriLDOGAnalysis/Atlas/invivo/0.76x0.76x0.76resampled_invivoTemplate.nii.gz -i %s/%s"%(flipped_epi,i,flipped_epi,i))
