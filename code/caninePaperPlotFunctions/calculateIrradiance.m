function cornIrradianceWattsPerArea = calculateIrradiance(luminance, calibration, calIndex)
...
theRawSpd = SplineSpd(cals{calIndex}.describe.S,cals{calIndex}.raw.fullOn,S);
