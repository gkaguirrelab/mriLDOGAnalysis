...
for ii = 1:length(subjects)
    ...
    if isequal(ii,1)
        ...
        fprintf(['\n For ' experiment ', mean luminance across subjects: ' num2str(mean(cell2mat(subjectMRIResults(:,2))),'%.2f') ' std: ±' num2str(std(cell2mat(subjectMRIResults(:,2))),'%.2f') '\n'])
        fprintf(['\n For ' experiment ', mean irradiance across subjects: ' num2str(mean(cell2mat(subjectMRIResults(:,3))),'%.2f') ' std: ±' num2str(std(cell2mat(subjectMRIResults(:,3))),'%.2f') '\n'])
    elseif isequal(ii,2)
        ...
        % Now report mean and SE luminance of all subjects
        fprintf(['\n For ' experiment ', mean luminance across subjects: ' num2str(mean(cell2mat(subjectPupilResults(:,2))),'%.2f') ' std: ±' num2str(std(cell2mat(subjectPupilResults(:,2))),'%.2f') '\n'])
        fprintf(['\n For ' experiment ', mean irradiance across subjects: ' num2str(mean(cell2mat(subjectPupilResults(:,3))),'%.2f') ' std: ±' num2str(std(cell2mat(subjectPupilResults(:,3))),'%.2f') '\n'])
    end

    % Print mean and SE contrast values
    for pr = 1:length(contrasts)      
        fprintf(['\n For ' experiment ', mean ' directionNames{pr} ' L+S across subjects: ' num2str(100*mean(contrasts{pr}(5,:)),'%.1f') ' std: ±' num2str(100*(std(contrasts{pr}(5,:))),'%.1f') '\n'])
        fprintf(['\n For ' experiment ', mean ' directionNames{pr} ' L-S across subjects: ' num2str(100*mean(contrasts{pr}(6,:)),'%.1f') ' std: ±' num2str(100*(std(contrasts{pr}(6,:))),'%.1f') '\n'])    
        fprintf(['\n For ' experiment ', mean ' directionNames{pr} ' Mel across subjects: ' num2str(100*mean(contrasts{pr}(3,:)),'%.1f') ' std: ±' num2str(100*(std(contrasts{pr}(3,:))),'%.1f') '\n'])
        fprintf(['\n For ' experiment ', mean ' directionNames{pr} ' Rod across subjects: ' num2str(100*mean(contrasts{pr}(4,:)),'%.1f') ' std: ±' num2str(100*(std(contrasts{pr}(4,:))),'%.1f') '\n'])      
    end
