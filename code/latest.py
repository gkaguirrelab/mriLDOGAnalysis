...
#    
    ...
    warp_call = "%s/antsRegistrationSyN.sh -d 3 -f %s -m %s -o %s/dog_diff -n 6"%(path_to_ants_scripts, template_path, averaged_mprage, warp_results_folder)
    os.system(warp_call)
    
    print("WARPING THE FLIPPED AVERAGED MPRAGE TO INVIVO ATLAS")
    warp_call2= "%s/antsRegistrationSyN.sh -d 3 -f %s -m %s -o %s/flipped_dog_diff -n 6"%(path_to_ants_scripts, template_path, flipped_averaged_mprage, warp_results_folder)
